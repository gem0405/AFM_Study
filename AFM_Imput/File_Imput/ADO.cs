...
namespace AFM_Imput
{
    public class ADO
    {
        ...
        public ADO()
        {
            conn = new SqlConnection(ConfigurationManager.ConnectionStrings["APM_Test"].ConnectionString);
            cmd = new SqlCommand();
            cmd.Connection = conn;
            //
            // TODO: 在這裡新增建構函式邏輯
        ...
        {
            conn = new SqlConnection(ConfigurationManager.ConnectionStrings[contxt].ConnectionString);
            cmd = new SqlCommand();
            cmd.Connection = conn;
            //
            // TODO: 在這裡新增建構函式邏輯
